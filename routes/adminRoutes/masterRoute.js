...
router
  .route("/update/:investigationId/results/:resultId")
  .put(updateSingleResult);
// 50. Update Investigation Normal Values
router
  .route("/update-normal/:resultId/normal-values/:normalValueId")
  .put(updateNormalValues);
// 51. Update Reflex Test
router
  .route("/update-reflex/:resultId/reflex-tests/:reflexId")
  .put(updateReflexTest);
